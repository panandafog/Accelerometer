...
struct Axes: VectorArithmetic {
    ...
    static var zero = getZero(displayableAbsMax: 0.0)
    
    static func getZero(displayableAbsMax: Double) -> Axes {
        Axes(
            x: 0.0,
            y: 0.0,
            z: 0.0,
    ...
    static func + (lhs: Axes, rhs: Axes) -> Self {
        Self(
            x: lhs.x + rhs.x,
            y: lhs.y + rhs.y,
            z: lhs.z + rhs.z,
    ...
    static func == (lhs: Axes, rhs: Axes) -> Bool {
        lhs.x == rhs.x &&
        lhs.y == rhs.y &&
        lhs.z == rhs.z &&
        lhs.minX == rhs.minX &&
